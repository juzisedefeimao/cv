        ...
        if self.train_step == 'train_step_detect':
            ...
            for iter in range(self.train_op['detect_restore_iter'], max_iters):
                ...
                detect_feed_dict = {
                    ...
                    detect_network.rois: roi_data[0],
                    detect_network.labels: roi_data[1],
                    detect_network.bbox_targets: roi_data[2],
                    detect_network.bbox_inside_weights: roi_data[3],
                    detect_network.bbox_outside_weights: roi_data[4]
                }
