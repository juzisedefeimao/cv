...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters, restore=False):
        ...
        # var = [v for v in tvars if v.name.split('/')[1] == 'conv2']
        # print('lll',tvars)
        # print('kkk',var)
        ...
        if self.pretrained_model is not None and not restore:
            try:
                ...
                self.net.load(self.pretrained_model, sess, True, op_step='cnn_encoder')
            except:
        ...
        for iter in range(restore_iter, max_iters):
            ...
            with open('D:\\jjj\\zlrm\\logs\\zlrm_relation_resnet_net_accuracy.txt', 'a') as f:
                f.write(save_data_txt + '\n')


            # print('jjj', gradients_val)
