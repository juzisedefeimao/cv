...
from function_network.zlrm.solverwrapper.relation_net_solverwrapper import train_net
...
def parse_args():
    ...
    parser.add_argument('--classifier_output', dest='classifier_output',
                        ...
                        default='D:\\jjj\\zlrm\\output\\zlrm_relation_net_classifier', type=str)
    ...
    parser.add_argument('--networks', dest='network_name',
                        ...
                        default='Relation_net_train', type=str)
