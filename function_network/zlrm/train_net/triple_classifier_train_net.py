...
from function_network.zlrm.solverwrapper.triple_classifier_solverwrapper import train_net
...
def parse_args():
    ...
    parser.add_argument('--imdb_train', dest='imdb_train_name',
                        ...
                        default='zlrmdata_triple_classify_train', type=str)
    parser.add_argument('--imdb_test', dest='imdb_test_name',
                        help='dataset to test on',
                        default='zlrmdata_triple_classify_test', type=str)
