...
from function_network.zlrm.solverwrapper.siammask_solverwrapper import get_training_roidb, train_net
...
if __name__ == '__main__':
    ...
    train_net(network, imdb, roidb,
              output_dir=args.siammask_output,
