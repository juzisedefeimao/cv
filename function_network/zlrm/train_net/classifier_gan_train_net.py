...
from function_network.zlrm.solverwrapper.classifier_gan_solverwrapper import train_net
...
def parse_args():
    ...
    parser.add_argument('--classifier_output', dest='classifier_output',
                        ...
                        default='D:\\jjj\\zlrm\\output\\Resnet18_gan_classifier', type=str)
