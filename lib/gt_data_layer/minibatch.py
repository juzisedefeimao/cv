...
def get_minibatch(roidb, num_classes):
    ...
    assert(cfg.ZLRM.TRAIN.BATCH_SIZE % num_images == 0), \
        'num_images ({}) must divide BATCH_SIZE ({})'. \
        format(num_images, cfg.ZLRM.TRAIN.BATCH_SIZE)
    ...
    num_scale = len(cfg.ZLRM.TRAIN.SCALES)
    ...
    num_aspect = len(cfg.ZLRM.TRAIN.ASPECTS)
    ...
    parameters_blob[2:2+num_scale] = cfg.ZlRM.TRAIN.SCALES
