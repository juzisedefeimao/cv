...
def prepare_roidb(imdb):
    ...
    for i in range(len(imdb.image_index)):
        ...
        # for each scale
        for scale_ind, scale in enumerate(cfg.ZLRM.TRAIN.SCALES):
            ...
            for k in range(1, imdb.num_classes):
                fg_inds.extend(np.where((max_classes == k) & (max_overlaps >= cfg.ZLRM.TRAIN.FG_THRESH))[0])
            ...
            if len(fg_inds) > 0:
                ...
                scale_map = cfg.ZLRM.TRAIN.SCALES[scale_ind_map]
