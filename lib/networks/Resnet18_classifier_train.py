...
class Resnet18_classifier_train(Network):
    def __init__(self):
        self.inputs = []
    ...
    def build_loss(self):
        ...
        cross_entropy_n = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=cls_score, labels=self.label)
    ...
    def setup(self):
        ...
        (
            self.feed('transform4_bn', 'res4_2_bn2')
                ...
                .avg_pool(7, 7, 7, 7, name='ave_pool')
                .fc(cls_num, relu=False, name='cls_score')
