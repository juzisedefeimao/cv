...
extern "C" __device__ inline float devIoU(float const * const a, float const * const b) {
...
extern "C" __global__ void nms_kernel(const int n_boxes, const float nms_overlap_thresh,
...
extern "C" void _set_device(int device_id) {
  int current_device;
...
extern "C" void _nms(long* keep_out, int* num_out, const float* boxes_host, int boxes_num,
