...
nvcc_compile_args = ['-O', '--ptxas-options=-v', '-arch=sm_30', '-c', '--compiler-options=-fPIC']
...
#                                      '--compiler-options',
#                                      "'-fPIC'"]},
#         include_dirs = [numpy_include, CUDA['include'], 'C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\include']
#     )
